...
EMAIL_REMETENE = os.getenv("EMAIL_REMETENTE")
...
def enviar_email(destinatario: str, assunto: str, mensagem: str):
    try:
        ...
        servidor.starttls()
        servidor.login(EMAIL_REMETENE, EMAIL_SENHA)
        servidor.sendmail(EMAIL_REMETENE, destinatario, msg.as_string())
        servidor.quit()
...
def email_confirmacao_agendamento(destinatario: str, nome_cliente: str, nome_barbeiro: str, data_hora: str):
